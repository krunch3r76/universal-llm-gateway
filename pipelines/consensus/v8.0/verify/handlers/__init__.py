...
def register_handlers(router) -> None:
    ...
    router.register_domain_handler_class(
        "consensus", "consensus_decompose_v8_0", DecomposeHandler
    )
    router.register_domain_handler_class(
        "consensus", "consensus_classify_domain_v8_0", ClassifyDomainHandler
    )
    router.register_domain_handler_class(
        "consensus", "consensus_atomicity_gate_v8_0", AtomicityGateHandler
    )
    router.register_domain_handler_class(
        "consensus", "consensus_contextualize_v8_0", ContextualizeHandler
    )
    router.register_domain_handler_class(
        "consensus", "consensus_domain_verify_v8_0", DomainVerifyHandler
    )
    router.register_domain_handler_class(
        "consensus", "consensus_verify_general_v8_0", VerifyGeneralHandler
    )
    router.register_domain_handler_class(
        "consensus", "consensus_filter_threshold_v8_0", FilterThresholdHandler
    )
