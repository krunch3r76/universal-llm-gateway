...
from ..._lib._chain_utils import filter_claims
from ..._lib._domain_verification import merge_authority_verdicts
...
class FilterThresholdHandler(BaseHandler):
    ...
    step_type: str = "consensus_filter_threshold_v8_0"
