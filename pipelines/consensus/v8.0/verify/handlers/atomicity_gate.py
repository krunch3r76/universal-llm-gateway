...
from ..._lib._decompose_compound import atomicity_gate_decompose
...
class AtomicityGateHandler(BaseHandler):
    ...
    step_type: str = "consensus_atomicity_gate_v8_0"
    ...
    async def execute(
        ...
        prompt_ref_classify = str(
            ...
            or "consensus.v8.0.classify_atomicity"
        )
        prompt_ref_decompose = str(
            step.get_domain_field("prompt_ref_decompose_compound")
            or "consensus.v8.0.decompose_general_compound"
        )
