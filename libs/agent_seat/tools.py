...
_CORTEX_OPS_DOC = (
    ...
    "  assertion_update (assertion_id, superseded_by?, valid_from?, valid_until?, confidence?, confidence_score?, review_status?, reviewer?, reviewed_at?, review_notes?, predicate_form?, force?) — valid_from is FILL-ONLY (409 when it would move an existing anchor) and predicate_form PATCH refuses a functor-class change; both take force=true.\n"
