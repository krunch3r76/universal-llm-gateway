...
def _insert_skill(
    ...
    *,
    ...
    conn.execute(
        "INSERT INTO entities (id, type, name, lifecycle, confidence_band, attributes, created_at) "
        "VALUES (?, 'agent_skill', ?, 'active', ?, ?, '2026-05-19T00:00:00Z')",
...
def test_fields_projection_decodes_attribute_list() -> None:
    ...
    for item in result["items"]:
        ...
        assert item["status"] == "confirmed · active"
