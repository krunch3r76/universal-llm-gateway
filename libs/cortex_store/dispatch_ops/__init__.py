...
_OP_SPECS: dict[str, str] = {
    ...
    "transcript_source_probe": (
        "ops_transcript_source_probe:_op_transcript_source_probe"
    ),
    ...
    "seat_claim": "ops_seat_claims:_op_seat_claim",
    "seat_heartbeat": "ops_seat_claims:_op_seat_heartbeat",
    "seat_release": "ops_seat_claims:_op_seat_release",
    "seat_claims_list": "ops_seat_claims:_op_seat_claims_list",
