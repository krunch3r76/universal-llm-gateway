...
def consume_time_wake_protocol(*, thread_id: str | None = None) -> str:
    ...
    return (
        ...
        "| unreachable.\n"
        "- unreachable (sandbox root not visible to this process): not a file-absence "
        "signal — do not STAND_DOWN on this token alone; re-read from a plane that "
        "can see cortex files or trust live bus tip / SEAT_REGISTRATION.\n"
        "- missing (file absent under a visible root): default STAND_DOWN. Absence is not permission "
