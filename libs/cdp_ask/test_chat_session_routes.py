...
def test_grok_harvest_200_emits_event(
    ...
    harvest_response = ChatHarvestResponse(
        ...
        url=GROK_URL,
        archive_uri=f"cortex://notes/system/threads/chat-harvest-grok-{GROK_ID[:12]}.messages.json",
        archive_sha256="a" * 64,
        turn_count=2,
    )
...
def test_claude_chat_harvest_200_emits_event(
    ...
    harvest_response = ChatHarvestResponse(
        ...
        url=CLAUDE_CHAT_URL,
        archive_uri="cortex://notes/system/threads/chat-harvest-claude-thread-uuid.messages.json",
        archive_sha256="c" * 64,
        turn_count=2,
    )
