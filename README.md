...
| Frontier models | `team_dispatch(op=..., role=..., dispatch_thread_id=..., ...)` for persona consults; `frontier_dispatch(op=..., model=...)` for raw provider-native reasoning and synthesis |
