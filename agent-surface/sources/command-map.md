...
|---|---|---|---|
| `/cortex-brief` | `.cursor/commands/cortex-brief.md` → continuity brief (`cortex_brief` + TIER-2 stubs; ¬ boot-into Cortex) | `cortex_brief(agent="claude-web", …)`; `agent-guides/web-agent-orientation.md` | Static orientation: `AGENTS.md` router + `docs/agent-guides/no-cortex.md` |
