...
| `/consult-plan` | `.cursor/commands/consult-plan.md` → `team_dispatch(generate)` or `handoff` per `agent-skills/consult-routing.md` | same; six-block packet (`.cursor/skills/handoff-packet-authoring/SKILL.md`) | In scope — reviewer receives inlined packet |
