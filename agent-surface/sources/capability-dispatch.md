...
Examples: `openai/gpt-5.5`, `anthropic/claude-sonnet-4-6`, `xai/grok-4.7`, `google/gemini-3-pro`
...
| `xai/grok-4.7` | `openai_responses` | same surface; implicit default effort `high` |
