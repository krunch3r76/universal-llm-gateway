...
|---|---|---|
| **Cursor IDE** | `.cursor/rules/` + `/mnt/torus/projects/.cursor/rules/` — start `cursor-environment_ws.mdc`; session open via `cortex_brief(agent=<seat>)` | `.cursor/commands/` + `docs/agent-guides/mvw-command-map.md` |
