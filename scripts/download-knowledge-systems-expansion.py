...
PAPERS: list[Paper] = [
    ...
    Paper(
        "2407.04363",
        "arigraph-episodic-memory-kg-agents.pdf",
    ...
    Paper(
        "2510.09156",
        "agentic-kgr-coevolutionary-multi-agent-rl.pdf",
    ...
    Paper(
        "2603.06290",
        "epistwin-personal-kg-neuro-symbolic.pdf",
    ...
    Paper(
        "2505.11140",
        "follow-the-path-kg-factuality.pdf",
    ...
    Paper(
        "2502.13247",
        "grounding-llm-reasoning-kg.pdf",
    ...
    Paper(
        "2603.13264",
        "federated-personal-kg-lightweight-llms.pdf",
    ...
    Paper(
        "2503.13514",
        "rag-kg-il-incremental-hallucination-reduction.pdf",
    ...
    Paper(
        "2405.03480",
        "personal-laps-multi-session-search.pdf",
    ...
    Paper(
        "2602.05818",
        "tkg-thinker-dynamic-reasoning-temporal-kg.pdf",
    ...
    Paper(
        "2502.12110",
        "a-mem-agentic-memory-zettelkasten.pdf",
    ...
    Paper(
        "2601.01885",
        "agemem-unified-ltm-stm-management.pdf",
    ...
    Paper(
        "2507.05257",
        "evaluating-memory-llm-agents-benchmark.pdf",
    ...
    Paper(
        "2603.17244",
        "kumiho-graph-native-belief-revision.pdf",
    ...
    Paper(
        "2601.02744",
        "synapse-episodic-semantic-spreading-activation.pdf",
    ...
    Paper(
        "2602.13530",
        "remem-reasoning-episodic-memory.pdf",
    ...
    Paper(
        "2603.19595",
        "all-mem-lifelong-memory-topology-evolution.pdf",
    ...
    Paper(
        "2505.07509",
        "halo-half-life-outdated-fact-filtering.pdf",
    ...
    Paper(
        "2512.15922",
        "spreading-activation-kg-rag-retrieval.pdf",
    ...
    Paper(
        "2602.05152",
        "rag-without-forgetting-evolving-memory.pdf",
    ...
    Paper(
        "2602.02007",
        "xmemory-hierarchical-memory-organization.pdf",
    ...
    Paper(
        "2603.15642",
        "cranimem-neurocognitive-memory-design.pdf",
    ...
    Paper(
        "2601.20465",
        "bmam-decomposed-memory-subsystems.pdf",
