...
PAPERS: list[Paper] = [
    ...
    Paper(
        "2408.08333",
        None,
        "codemirage-hallucinations-benchmark.pdf",
        "CodeMirage: Hallucinations in Code Generated by Large Language Models",
    ),
    Paper(
        "2504.20799",
        None,
        "hallucination-codegen-taxonomy-survey.pdf",
