...
class TelemetryStateTracker:
    ...
    def __init__(self, node_id: str):
        ...
        # Sequence when accumulator was last populated
        self._accumulated_seq: int = 0
        # Sequence number on last poll (for delivery detection)
        self._last_poll_seq: int = 0
    ...
    def get_delta(self) -> dict[str, Any]:
        ...
        """
        # If Master polled again at same seq, previous delta was delivered
