...
def register_cortex_tools(mcp: FastMCP) -> None:
    ...
    def cortex(tool: str, arguments: str = "{}") -> Any:
        ...
        Operations:
          ...
          assertion_update  (assertion_id, superseded_by?, valid_until?, confidence?, review_status?, reviewer?, reviewed_at?, review_notes?, predicate_form?) — update assertion metadata (predicate_form=NULL clears the field; other nullable fields treat absent and null identically — use supersede to retract a value)
