    ...
    def cortex(tool: str, arguments: JsonArgStr = "{}") -> Any:
        """Cortex knowledge system — entities, assertions, relationships, edges, journals.
                ...
                arguments: JSON-encoded object string (e.g. '{"entity_id": "type:slug"}').
                  Large/quote-heavy payloads (session_close transcript_md /
                  session_summary_md / handoff_prompt): do NOT hand-build the JSON
                  string — write the payload to a file and pass a file-path param
                  (session_summary_md_path / transcript_jsonl_path /
                  handoff_source_path / source_ref), or use the /agent-bus CLI,
                  which bypasses MCP shape validation.
