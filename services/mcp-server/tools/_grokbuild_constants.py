...
The ``_MODEL_REGISTRY`` replaces the former ``_NON_REASONING_MODELS``
...
#
# ∀ model ∉ _MODEL_REGISTRY: both effort flags treated as supported (pass-
...
_MODEL_REGISTRY: Final[dict[str, _ModelCapabilities]] = {
