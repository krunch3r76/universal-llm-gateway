...
from services.rag.property_index.mixin_09_articles_ops import _PropertyIndexPart09


class PropertyIndex(
    _PropertyIndexPart01,
    _PropertyIndexPart02,
    _PropertyIndexPart03,
    _PropertyIndexPart04,
    _PropertyIndexPart05,
    _PropertyIndexPart06,
    _PropertyIndexPart07,
    _PropertyIndexPart09,
    _PropertyIndexPart08,
):  # type: ignore[misc]
