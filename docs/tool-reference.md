...
3. `agent_bus(tool="wait", arguments=poll_hint.arguments_json)` — or build the same
   ...
   Cursor-IDE seats receive `wait_seconds=0`; web/API keep 300 (Anthropic MCP
   client ceiling; friction 24081 + operator bind 2026-08-02).
