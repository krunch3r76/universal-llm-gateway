...
| `[ulg:events-first]` | Query Event Service before application logs | Issue investigation, pipeline/request debug | → `workspaces://universal-llm-gateway/.cursor/rules/event-debugging_ws.mdc` |
