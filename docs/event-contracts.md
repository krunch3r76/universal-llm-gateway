...
<!-- GENERATED:START region=capacity inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=federated inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=model inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=request inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=routing inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=scheduler inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=token inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `debug.cloud.params.stripped` | `provider`, `model`, `stripped` (list[str]), `surface` (`chat_completions` \| `responses` \| `responses_stream` \| `messages` \| `messages_stream` \| `native` \| `native_stream`) |
...
**Note**: `debug.cloud.params.stripped` fires when a cloud-proxy adapter drops
params the upstream model rejects. OpenAI-compatible (`provider=openai`,
surfaces `chat_completions` / `responses` / `responses_stream`) drops
`temperature` / `top_p` / `presence_penalty` / `frequency_penalty` for
reasoning families (`gpt-5`, `o1`, `o3`, `o4`). Anthropic (`provider=anthropic`,
surfaces `messages` / `messages_stream` / `native` / `native_stream`) drops
`temperature` / `top_p` / `top_k` for Claude 5 and Opus 4.7+ families. xAI
Grok, non-reasoning OpenAI (gpt-4o, gpt-4-turbo), and Claude 4.6 and earlier
pass through unchanged and do not emit this signal.
...
<!-- GENERATED:START region=federation inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=gateway inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=guidance inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
### Continuity tape events

Observation signals for the continuity-messages pipeline (JSONL extract, seal, tape read).

<!-- GENERATED:START region=continuity inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:END region=continuity -->

### RAG Events

<!-- GENERATED:START region=rag inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=mcp inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `mcp.agentbus.resume.fence.poured` | `fence_id`, `root_thread`, `bundle_bytes`, `readable_counts`, `seal_status`, `mission_bytes`, `card_inlined`, `bundle_version`, `bundle_sha256` | Signal: mcp.agentbus.resume.fence.poured |
| `mcp.agentbus.resume.fence.released` | `fence_id`, `release_turn` | Signal: mcp.agentbus.resume.fence.released |
| `mcp.agentbus.send.hold.measured` | `thread`, `route`, `is_checkpoint`, `body_chars`, `spilled`, `mint_hold_ms`, `prepare_ms`, `insert_call_ms` | Signal: mcp.agentbus.send.hold.measured |
...
| `mcp.agentbus.thread.entity.mint.failed` | `thread`, `entity_id`, `error`, `phase` | Signal: mcp.agentbus.thread.entity.mint.failed |
...
| `mcp.agentbus.thread.orphaned` | `thread_id`, `reason`, `error?` | Signal: mcp.agentbus.thread.orphaned |
...
| `mcp.chat.session.harvested` | `site`, `conversation_id`, `outcome`, `turn_count`, `archive_uri?`, `archive_sha256?`, `superseded_sha256?`, `code?`, `conflict_ordinal?`, `opened_on_demand?` | Emit when harvest completes, refuses, or conflicts after classifier accept. |
| `mcp.chat.session.pasted` | `site`, `conversation_id`, `ok`, `url?`, `archive_uri?`, `archive_sha256?`, `code?` | Emit after paste completes or refuses once grant and classifier passed. |
| `mcp.continuity.checkpoint.requested` | `surface`, `thread` | - |
| `mcp.continuity.tape_read.requested` | `thread`, `scope`, `door` | - |
...
| `mcp.cse.session.harvested` | `registration_id`, `outcome`, `ack_class`, `turn_count`, `reason`, `waited_ms`, `identity_check` | Emit when harvest completes or reports an incomplete outcome. |
...
<!-- GENERATED:START region=doc inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=frontier inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `frontier.cdp.packet.enriched` | `request_id`, `packet_path`, `to_agent`, `web_mcp_stamped` | CDP generate stamped Block 5 MCP defaults before prompt staging (a:32088). |
| `frontier.densify.review.admitted` | `parent_request_id`, `parent_execution_id`, `parent_dispatch_thread_id`, `densify_thread_id`, `staged_draft_uri`, `reasoning_trace_uri`, `density_triage`, `draft_adequacy`, `opt_out`, `opt_out_reason_code`, `reviewer_identity`, `reviewer_rung`, `reviewer_model`, `target_thread_id`, `review_execution_id`, `auto_review_child`, `review_spawned`, `hold_reason` | Default-on densify candidate admitted, opted-out, or blank-held. |
...
| `frontier.review_child.prompt_bind` | `parent_execution_id`, `child_execution_id`, `delivery_thread_id`, `prompt_bind_mode`, `prompt_turn_number`, `latest_read_outcome`, `bound_prompt_class`, `bound_prompt_digest` | Spawn-hook prompt bind instrumentation — Path-1 vs Path-2 (6655). |
| `frontier.sdk.admit.branch_debt_lineage_refused` | `dispatch_id`, `thread_id`, `work_key`, `debt_branch`, `debt_thread_id`, `contract`, `caller_agent`, `mode` | - |
...
| `frontier.sdk.admit.identity_adhoc` | `dispatch_id`, `thread_id`, `work_key`, `identity_class`, `contract`, `caller_agent`, `mode` | - |
| `frontier.sdk.admit.remint` | `dispatch_id`, `thread_id`, `work_key`, `work_key_seq`, `prior_dispatch_id`, `prior_terminal_status`, `contract`, `caller_agent`, `mode` | - |
| `frontier.sdk.admit.work_key_in_flight_forced` | `dispatch_id`, `thread_id`, `work_key`, `force_reason`, `contract`, `caller_agent`, `mode` | - |
...
| `frontier.sdk.bridge.exited` | `dispatch_id`, `thread_id`, `elapsed_s`, `stderr_bytes`, `stderr_tail`, `log_path`, `exit_code?`, `signal_name?`, `bridge_death_class?`, `bridge_spawn_cwd?`, `bridge_spawn_cwd_exists?`, `bridge_process_cwd?` | - |
...
| `frontier.sdk.conductor.hop.admit_failed` | `dispatch_id`, `thread_id`, `hop_seq`, `hop_reason`, `error`, `status_code?` | Reactor POST to Stargate team_dispatch failed for a owed hop. |
| `frontier.sdk.conductor.hop.admit_refused_parked` | `thread_id`, `parked_dispatch_id`, `reason`, `work_key?` | Park gate refused a conductor admit while mission remains parked. |
| `frontier.sdk.conductor.hop.admitted` | `predecessor_dispatch_id`, `successor_dispatch_id`, `thread_id`, `hop_seq`, `hop_reason` | Substrate admitted a conductor hop successor after predecessor terminal. |
...
| `frontier.sdk.pool.denied` | `request_id`, `seat`, `requested_model`, `resolved_model`, `pool`, `code` | Other Models pool refused at cursor-sdk generate prepare. |
| `frontier.sdk.pool.exempted` | `request_id`, `seat`, `requested_model`, `resolved_model`, `pool`, `code` | Explicit Other Models pin admitted at cursor-sdk generate prepare. |
...
| `frontier.sdk.review_child.spawned` | `execution_id`, `parent_execution_id`, `parent_thread_id`, `reviewer_model`, `reviewer_identity`, `reviewer_rung`, `executor_identity`, `executor_rung`, `dedupe_key` | Auto review child spawned after generate/cursor-sdk worker completion. |
| `frontier.sdk.steer.inject.delivered` | `dispatch_id`, `entry_id`, `authority_turn_id` | - |
| `frontier.sdk.steer.inject.escalated` | `dispatch_id`, `entry_id`, `reason` | - |
| `frontier.sdk.steer.inject.expired` | `dispatch_id`, `entry_id`, `ttl_s` | - |
| `frontier.sdk.steer.inject.requested` | `dispatch_id`, `thread_id`, `entry_id`, `ttl_s`, `actor` | - |
...
| `frontier.sdk.worker.progress` | `dispatch_id`, `thread_id`, `resolved_model`, `elapsed_s`, `tool_call_count`, `execution_id?`, `usage_live?` | - |
| `frontier.sdk.worker.queued` | `dispatch_id`, `thread_id`, `source_repo`, `queue_position`, `holder_dispatch_id?`, `holder_thread_id?`, `holder_resolved_model?`, `holder_subject_preview?`, `resolved_model?`, `execution_id?`, `admitted_via?`, `asked_by?`, `purpose?`, `story_id?`, `queued_on?`, `topic?`, `nest_under?`, `packet_kind?`, `model_knobs_requested?` | - |
| `frontier.sdk.worker.queued` | `request_id`, `thread_id`, `execution_id`, `queue_position`, `dispatch_id?`, `asked_by?`, `purpose?`, `story_id?`, `admitted_via?`, `seat?`, `nest_under?`, `topic?`, `packet_kind?`, `model_knobs_requested?` | SDK worker dispatch durably queued awaiting write-lease. |
| `frontier.sdk.worker.resumed` | `dispatch_id`, `resume_of`, `sdk_agent_id`, `state_root`, `thread_id`, `execution_id`, `parent_terminal_status?` | - |
| `frontier.sdk.worker.skills.mounted` | `dispatch_id`, `thread_id`, `resolved_model`, `staged`, `preexisting`, `unresolved`, `mounted_count`, `rows`, `execution_id?` | - |
...
<!-- GENERATED:START region=delivery inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=pipeline inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=consult inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=conductor inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:END region=conductor -->
...
<!-- GENERATED:START region=cloudproxy inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=life inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
Emitted by `libs/bus_watch/events.py` for liaison seat lifecycle: night_id reset,
lease forfeiture, pending_spawn release, and root CHECKPOINT observation on the
bus_watch driver path.

<!-- GENERATED:START region=liaison inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `liaison.checkpoint.observed` | `root`, `turn`, `prior_turn`, `source` | - |
| `liaison.lane_closeout.emitted` | `root`, `lane`, `terminal_status`, `abandoned`, `turn` | - |
| `liaison.lease.forfeited` | `root_id`, `holder`, `expires_at`, `last_holder_turn` | - |
| `liaison.night_id.reset` | `root_id`, `previous_night_id`, `new_night_id`, `previous_hops` | - |
| `liaison.now_row.bound` | `root_id`, `row`, `tier`, `lane_id`, `superseded`, `as_of` | - |
| `liaison.now_row.released` | `root_id`, `row`, `lane_id`, `reason`, `as_of` | - |
| `liaison.pending_spawn.released` | `root_id`, `execution_id`, `thread_id`, `reason`, `spawned_at` | - |
<!-- GENERATED:END region=liaison -->
...
<!-- GENERATED:START region=graph inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=cortex inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `cortex.entity.alias.ambiguous` | `ref`, `entity_type`, `match_count` | cortex.entity.alias.ambiguous — alias lookup matched multiple entities. |
| `cortex.entity.create.id_rejected` | `entity_type`, `supplied_id`, `caller` | cortex.entity.create.id_rejected — id supplied for a minted type. |
| `cortex.entity.id.minted` | `entity_id`, `entity_type`, `mint` | cortex.entity.id.minted — server mint on create for referent types. |
| `cortex.entity.name.changed` | `entity_id`, `prior_name`, `name`, `prior_name_retained` | cortex.entity.name.changed — authority transition on display name. |
| `cortex.entity.name.duplicate_rejected` | `entity_type`, `name`, `existing_entity_id` | cortex.entity.name.duplicate_rejected — near-duplicate name blocked at create. |
...
| `cortex.session_close.root_window_depth_upgraded` | `session_id`, `thread_id`, `prior_depth`, `new_depth` | Root lane window depth upgraded to verbatim on close. |
| `cortex.session_close.succession_structural_filled` | `session_id`, `agent`, `journal_row_id`, `extended`, `reason`, `cause` | A-1 human close filled structural layer on a succession-sealed row; `closed_by` flipped to closing agent. `cause` ∈ {`no_jsonl`, `diverged`, `prefix_extend`}. |
| `cortex.session_close.succession_user_turn_bypass` | `session_id`, `closed_by`, `coverage`, `message_count`, `user_turn_count` | - |
...
| `cortex.transcript.discover.filtered` | `reason`, `thread_id`, `transcript_id` | Discover excluded a JSONL window (`no_touch`, `read_only`, `foreign_dominant`). |
| `cortex.transcript.harvested` | `thread_id`, `discovered`, `sealed`, `deferred`, `refused` | transcript_harvest sealed a capped batch of bindable windows. |
| `cortex.transcript.legacy_md_read` | `session_id`, `sentinel_count`, `marker_count`, `user_marker_hits` | Legacy md-v1 verbatim read during tape pour (`sentinel_count`, `marker_count`, `user_marker_hits`). |
| `cortex.transcript.projected` | `thread`, `windows_scanned`, `parsed`, `windows_changed`, `cells_added`, `anchor_mismatches`, `elapsed_ms` | transcript_project run completed (or dry-run compute) for a root continuity lane. |
| `cortex.transcript.projection_anchor_mismatch` | `thread`, `cp_turn`, `kind` | One CP Window anchor mismatch detected during projection. |
| `cortex.transcript.projection_refused` | `thread`, `code` | transcript_project refused before any durable write. |
| `cortex.transcript.seal.codec_diverged` | `session_id`, `transcript_id`, `prior_codec`, `reason` | - |
| `cortex.transcript.seal.refused_not_lane_window` | `thread_id`, `conversation_uuid`, `binding` | transcript_seal refused a window that does not bind to the requesting lane. |
| `cortex.transcript.seal.verbatim_diverged` | `session_id`, `transcript_id`, `mode`, `codec`, `sealed_turns`, `live_turns`, `first_divergent_index` | Derived seal/JSONL prefix mismatch observed on succession fill or extend; advisory only (R2). |
| `cortex.transcript.sealed_by_succession` | `session_id`, `thread_id`, `conversation_uuid`, `turn_count` | Idle window sealed at resume via `transcript_seal` (`closed_by=succession`). |
...
<!-- GENERATED:START region=email inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `session.already_closed` | Persist of a **sealed** `session_id` (migration 034 UNIQUE). Detail object carries the prior `transcript_entity_id`, `transcript_path`, `journal_row_id`. Preflight hops (`hop_reason=session_id_already_journaled`) when a later JSONL user turn exists — that is a **new** close, not this 422. | Same-close retry only: quote the IDs. If preflight hopped, close the successor. |
...
### Predicate-normalize graduation signals (Wave 1)

Emitted by the cortex-api dispatcher layer (`libs/cortex_store/dispatch_ops/_assertions_shared.py`) and the T0 adjudicator (`libs/cortex_store/renormalize.py`). Wave 1 graduation honesty (todo:cortex-predicate-normalize-graduation-honesty) — sync MCP writes fire `mcp.cortex.predicate.*`; T0 mechanical clears fire `cortex.predicate.*`.

All signals: `role="observation"`, `scope="global"`. Source: `cortex-api` / dispatcher contract layer.

**Consumer gap (G4 R1):** no dedicated subscriber yet; extract writeback and session routing remain future work. `session_id` is populated on MCP-mediated writes when the caller passes it; extract pipeline writeback currently omits it.

| Signal | When emitted | Required payload | Optional payload |
|---|---|---|---|
| `mcp.cortex.predicate.normalized` | Every assertion write that surfaces `predicate_form_normalize` | `assertion_id`, `canonical_form`, `normalized` (bool), `requires_human_review` (bool) | `predicate_form_in`, `classes_applied`, `reason`, `session_id`, `normalization_decision`, `suppression_effect`, `_next` |
| `mcp.cortex.predicate.review.required` | Same write when `requires_human_review=true` | Same as normalized row | `session_id` — originating MCP session for async routing; null when caller omitted or on extract writeback |
| `cortex.predicate.review.cleared` | T0 adjudicator clears a flagged row (`t0_adjudicate_flagged`, `dry_run=false`) | `assertion_id`, `reviewer` (e.g. `normalizer:v1.4.0`), `inferred_reason` | — |
| `cortex.predicate.renormalize.pass_complete` | End of T0 pass (`dry_run=false`) | `before_count`, `after_count`, `cleared_count`, `by_reason`, `dry_run`, `sample_cleared_ids` | `stratify_snapshot` (full dry-run stratify list — prefer sidecar for large populations) |

**`session_id` semantics:** MCP dispatch ops pass the caller's session id through to `mcp.cortex.predicate.review.required` so async consumers can route review work back to the originating seat. When absent (dominant extract writeback path), consumers must recover context from the assertion row or bus thread — not from the event alone.
...
<!-- GENERATED:START region=git inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=cursor inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=cdp_ask inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=cdp inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `cdp.generate.delivery_failed` | `request_id`, `execution_id`, `thread_id`, `stall_stage`, `http_status?`, `detail_preview?`, `archive_uri?` | On-behalf bus delivery failed after harvest or failure body. |
| `cdp.generate.horizon.unverifiable` | `request_id`, `execution_id`, `satellite_execution_id`, `thread_id`, `stall_stage`, `error` | Non-terminal horizon retain: attach unverifiable, not generate death. |
| `cdp.generate.proof` | `request_id`, `execution_id`, `satellite_execution_id`, `archive_uri`, `content_proof_uri`, `via`, `attested_by?`, `thread_id?`, `pointer_turn?`, `dispatch_link_terminal?`, `registration_id?`, `chat_url?` | Harvest proof present (archive or content_proof). |
| `cdp.generate.reconciled` | `request_id`, `execution_id`, `satellite_execution_id`, `via` | Non-terminal observation when reconcile finalizes a zombie leg. |
| `cdp.generate.seated` | `request_id`, `execution_id`, `satellite_execution_id`, `registration_id`, `chat_url`, `seating_ordinal`, `observed_at`, `terminal` | First observation of a CSE chat URL inside generate poll scope. |
| `cdp.generate.stalled` | `request_id`, `execution_id`, `satellite_execution_id`, `stall_stage`, `error`, `progress_trace`, `archive_uri`, `deliverable_present`, `since_last_progress_s`, _dynamic_ | CDP generate terminated without proof (stall or satellite failure). |
| `cdp.generate.submitted` | `request_id`, `execution_id`, `satellite_execution_id`, `model` | Satellite project-ask accepted the submit. |
| `cdp.lane.standing.down` | `lane`, `port`, `observed_at` | Standing CDP lane down (unit inactive or CDP refused). `lane`, `port`, `observed_at`. |
| `cdp.lane.standing.hung` | `lane`, `port`, `observed_at` | Standing CDP lane hung (HTTP /json/version answers; bounded CDP WebSocket round-trip timed out). `lane`, `port`, `observed_at`. |
| `cdp.lane.standing.lapsed` | `lane`, `port`, `observed_at`, `url_prefix` | Standing CDP lane lapsed (vendor session dead while CDP answers). `lane`, `port`, `observed_at`, `url_prefix`. |
| `cdp.lane.standing.up` | `lane`, `port`, `observed_at` | Standing CDP lane up and not lapsed. `lane`, `port`, `observed_at`. |
| `cdp.occupancy.overlap` | `lane`, `execution_ids` | Census OVERLAP: ≥2 operator-purpose streams on one recorded lane. |
| `cdp.occupancy.updated` | `live_cse_count`, `open_attachment_count`, `live_cse_target_count`, `live_port_count`, `registry_capacity_count`, `freshness`, `previous_freshness`, `error` | Report changed CDP host, target, and unique-session occupancy evidence. |
| `cdp.parent_thread.conflict` | `registration_id`, `from_row`, `request` | - |
| `cdp.port.deregistered` | _dynamic_ | - |
| `cdp.port.dormant` | `registration_id`, `port`, `purpose`, `chat_url`, `reason` | Chrome released while the CSE URL and profile stay durable for relaunch. |
| `cdp.port.dormant_reclaimed` | `registration_ids`, `count`, `trigger` | Dormant rows dropped past TTL or over the row cap. |
| `cdp.port.exit_kill_decision` | `purpose`, `registration_id`, `port`, `kill` | - |
| `cdp.port.orphan_scan` | `ports_live`, `ports_skipped_registered`, `ports_examined`, `matched_count`, `rejected_count`, `unevaluable_count`, `closable_count`, `protected_count`, `reclaim_enabled` | - |
| `cdp.port.orphaned_alive_reaped` | `registration_id`, `port`, `trigger`, `reaped_orphaned_alive` | - |
| `cdp.port.reattached` | _dynamic_ | - |
| `cdp.port.registered` | _dynamic_ | - |
| `cdp.port.relaunched` | `registration_id`, `port`, `purpose`, `chat_url` | Dormant seat reopened on a fresh port using its retained profile. |
| `cdp.protocol.parked` | `cse_id`, `registration_id`, `thread`, `turn_id`, `obligation_id`, `wake_channel`, `fallback` | Transition-class: PARKED mirror opens wake_owed obligation. |
| `cdp.provenance.bound` | `episode_id`, `chat_url`, `registration_id`, `cdp_url`, `lane_thread`, `parent_thread`, `lane_role`, `evidence_class`, `attribution_source`, `correlation_id`, `lineage_state?`, `association_id?` | Report a durable CSE provenance episode and its observed lineage. |
| `cdp.provenance.conflict` | `chat_url`, `candidate_count`, `correlation_id` | Report multiple active provenance candidates for one CSE URL. |
| `cdp.provenance.historical` | `episode_id`, `chat_url`, `reason` | Report a retained episode that is no longer the current CSE binding. |
| `cdp.provenance.unresolved` | `chat_url`, `reason`, `correlation_id` | Report a CSE identity that lacks sufficient evidence for a unique join. |
| `cdp.seat.authority_unreachable` | `parent_thread`, `recovery` | Advisory: seat authority HTTP projection failed for *parent_thread*. |
| `cdp.seat.lane_bound` | `registration_id`, `seat_lane`, `superseded_registration_id?` | Seat axis bound: this registration is the open driving seat for *seat_lane*. |
| `cdp.seat.lane_reconciled` | `registration_id`, `seat_lane`, `released_registration_ids`, `released_count` | Multi-close convergence: one bind closed two or more predecessor seats. |
| `cdp.seat.lane_released` | `registration_id`, `seat_lane`, `reason` | Seat axis released: the registration no longer holds an open driving seat. |
| `cdp.seat.superseded` | `outgoing_registration_id`, `successor_registration_id`, `reason`, `registration_id` | Rebind closed open wake_owed / stop_ack_owed on the outgoing registration. |
| `cdp.skill.context_loaded` | `ok`, `required`, `observed`, `missing`, `context_found`, `skills_heading_found`, `error`, `execution_id`, `satellite_execution_id` | Post-submit Context → Skills receipt (non-gating observation). |
| `cdp.skill.delivery_attested` | `ok`, `attached`, `inlined`, `undelivered`, `wrong_channel`, `rows`, `execution_id`, `satellite_execution_id` | Observation event for sealed CDP skill channel attest (success or fail). |
| `cdp.wake.alarm_fired` | `cse_id`, `registration_id`, `thread`, `obligation_id`, `fallback`, `outcome_code` | Transition-class: TTL alarm on unpaid wake_owed. |
| `cdp.wake.delivered` | `cse_id`, `registration_id`, `thread`, `obligation_id`, `send_verified` | Transition-class: followup success discharges wake_owed. |
<!-- GENERATED:END region=cdp -->
...
<!-- GENERATED:START region=git_worker inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `git_worker.admission.rejected` | `kind`, `route`, `intent_id`, `drain_epoch` | - |
| `git_worker.dispatch.rejected` | _dynamic_ | - |
| `git_worker.drain.belt.exit` | `reason` | - |
| `git_worker.drain.completed` | `intent_id`, `drain_epoch`, `worker_id`, `pid`, `completed_at`, `active_count` | - |
| `git_worker.drain.completion_gate.failed` | `intent_id`, `drain_epoch`, `worker_id`, `pid`, `error_type` | - |
...
<!-- GENERATED:START region=giw inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=sdk inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `sdk.lane_b.pin_released` | `worktree_path`, `reason`, `dispatch_id?`, `thread_id?`, `actor?` | - |
| `sdk.lane_b.pinned` | `dispatch_id`, `thread_id`, `worktree_path`, `lock_reason`, `retro?` | - |
| `sdk.lane_b.pinned_worktree_vanished` | `dispatch_id`, `thread_id`, `worktree_path`, `ledger_status`, `bridge_pid?` | - |
| `sdk.lane_b.reap_skipped_live_bridge` | `worktree_path` | - |
| `sdk.lane_b.reaped` | `dispatch_id`, `branch_deleted`, `branch?`, `tip_sha?`, `reason?` | - |
| `sdk.lane_b.reconcile_skipped_live_ledger` | `worktree_path`, `dispatch_id?` | - |
| `sdk.lane_b.registry_ghost_row` | `worktree_path` | - |
| `sdk.lane_b.registry_quarantined` | `thread_id`, `source_repo`, `worktree_path`, `branch_name` | - |
| `sdk.lane_b.registry_registered` | `thread_id`, `source_repo`, `worktree_path`, `branch_name` | - |
| `sdk.lane_b.registry_unregistered` | `thread_id`, `source_repo`, `worktree_path`, `branch_name` | - |
| `sdk.lane_b.release_refused` | `reason`, `worktree_path`, `dispatch_id?`, `thread_id?` | - |
...
| `sdk.lane_b.worktree_removed` | `worktree_path`, `trigger`, `ledger_status_at_remove` | - |
| `sdk.lane_b.worktree_root_collapsed` | `call_site`, `path_before`, `path_after`, `worktree_root`, `dispatch_id?`, `thread_id?` | - |
| `sdk.park.bridge_abort_escalated` | _dynamic_ | A parked dispatch's bridge lingered past the idle budget and was closed. |
| `sdk.park.discard.requested` | _dynamic_ | A dispatch was asked to discard (kill without resume). |
| `sdk.park.discarded` | _dynamic_ | The row reached terminal ``cancelled`` with ``park_kind=cancel_discard``. |
| `sdk.park.expired` | _dynamic_ | Auto-resume TTL elapsed with no child; manual ``resume_of`` still possible. |
| `sdk.park.parked` | _dynamic_ | The row reached terminal ``cancelled`` with park columns set (resumable). |
| `sdk.park.refused` | _dynamic_ | Park preflight or cancel ladder refused; nothing was mutated. |
| `sdk.park.requested` | _dynamic_ | A live dispatch was asked to park; its bridge run is being cancelled. |
| `sdk.park.resume_admitted` | _dynamic_ | GIW admitted a ``resume_of`` child for a parked row (lineage continues). |
| `sdk.park.resume_refused` | `parent_dispatch_id`, `reason`, `attempt` | Auto-resume admission was refused; the park row stays open for the next tick. |
| `sdk.park.sweep` | `intent_id`, `requested`, `refused`, `already_parked`, `live_after`, `drain_epoch?` | One ``park-for-restart`` sweep summary for a restart intent. |
| `sdk.restart.deferred_live_bridge` | `bridge_count`, `force`, `intent_id?` | - |
...
<!-- GENERATED:START region=grokbuild inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=agent_bus inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `agent_bus.checkpoint.lid_seal_requested` | `thread`, `transcript_id`, `turns_at_cp` | Signal: agent_bus.checkpoint.lid_seal_requested |
| `agent_bus.checkpoint.producers_projected` | `thread`, `producer_count`, `execution_ids` | Signal: agent_bus.checkpoint.producers_projected |
| `agent_bus.tape.harvest_failed` | `thread_id`, `reason` | - |
| `agent_bus.tape.harvest_rendered` | `thread_id`, `discovered`, `sealed`, `deferred` | Tape route completed harvest+render for a root lane. |
| `agent_bus.tape.hop_cells_skipped` | `thread_id`, `scope`, `channel`, `hop_cells_skipped`, `wall_cp_ordinal`, `wall_bus_turn_id` | - |
| `agent_bus.tape.rendered` | `thread_id`, `segment_count`, `turn_count`, `truncated`, `scope`, `tools`, `include_extras`, `index_count`, `segment_codec_counts`, `surfaces`, `tools_available`, `foreign_cells_excluded`, `ownership_unresolved`, `codec_fallback_count`, `budget_source?` | Continuity tape render completed for a root lane. |
...
<!-- GENERATED:START region=catalog inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `catalog.reloaded` | `reason` | Create CATALOG_RELOADED event. |
<!-- GENERATED:END region=catalog -->

<!-- GENERATED:START region=close inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `close.check.completed` | `session_id`, `agent`, `revision`, `status`, `gap_count` | - |
| `close.commit.completed` | `session_id`, `agent`, `journal_row_id`, `transcript_depth` | - |
| `close.draft.opened` | `session_id`, `agent`, `revision` | - |
| `close.draft.reflections.flushed` | `session_id`, `agent`, `reflection_count` | - |
| `close.draft.updated` | `session_id`, `agent`, `revision` | - |
| `close.handoff.upserted` | `session_id`, `journal_row_id` | - |
<!-- GENERATED:END region=close -->

<!-- GENERATED:START region=closeout inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `closeout.seal.refused` | `path`, `surface` | - |
<!-- GENERATED:END region=closeout -->

<!-- GENERATED:START region=cloud inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `cloud.proxy.available` | `proxy_url`, `model_count` | Proxy became reachable and catalog was fetched. |
| `cloud.proxy.browser.catalog.refresh.failed` | `trigger`, `error` | Emit failed browser catalog refresh event. |
| `cloud.proxy.browser.catalog.refreshed` | `trigger`, `model_count` | Emit successful browser catalog refresh event. |
| `cloud.proxy.browser.lookup.miss` | `model_id` | Emit browser lookup miss event for model IDs. |
| `cloud.proxy.browser.select.completed` | `selected_count`, `tags`, `exclude_tags`, `sort_by`, `min_context`, `modality_contains`, `max_completion_cost`, `auto_excluded_multimodal` | Emit successful browser model selection event. |
| `cloud.proxy.browser.select.failed` | `error` | Emit failed browser model selection event. |
| `cloud.proxy.browser.ui.unavailable` | `missing_files` | Emit browser UI unavailable event for missing assets. |
| `cloud.proxy.catalog.fetch.failed` | `proxy_url`, `error` | Failed to fetch catalog from cloud proxy. |
| `cloud.proxy.catalog.refresh.failed` | `provider`, `error` | Emit failed provider catalog refresh event. |
| `cloud.proxy.catalog.refreshed` | `provider`, `model_count` | Emit successful provider catalog refresh event. |
| `cloud.proxy.catalog.updated` | `proxy_url`, `model_count`, `gateway_count` | Proxy catalog was re-fetched and virtual gateways were updated. |
| `cloud.proxy.dispatch.catalogmiss` | `provider`, `model_id`, `reason` | Emit when a cloud catalog model has no resolvable dispatch facet. |
| `cloud.proxy.local.catalog.refreshed` | `stargate_url`, `model_count` | Emit successful local catalog refresh event. |
| `cloud.proxy.local.catalog.unavailable` | `stargate_url`, `error` | Emit local catalog unavailable event. |
| `cloud.proxy.mcp.configured` | `provider`, `mcp_server_url` | Emit MCP server configured event at startup for providers with mcp_server_url set. |
| `cloud.proxy.request.failed` | `provider`, `model`, `status_code`, `error`, `adapter_type` | Emit request failure event for cloud provider calls. |
| `cloud.proxy.request.forwarded` | `provider`, `model`, `streaming`, `adapter_type`, `surface`, `mcp_injected` | Emit request forwarded event for cloud provider calls. |
| `cloud.proxy.request.translation.failed` | `provider`, `model`, `error`, `direction`, `adapter_type` | Emit request/response translation failures from provider adapters. |
| `cloud.proxy.shutdown` | `reason` | Emit cloud proxy shutdown lifecycle event. |
| `cloud.proxy.started` | `pid`, `mode`, `socket_path` | Emit cloud proxy startup lifecycle event. |
...
<!-- GENERATED:START region=compute inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=dispatch inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `dispatch.skills.inline.rejected` | `request_id`, `role`, `model`, `skills`, `budget_bytes`, `reason_code` | Caller-origin Layer-C inline injection rejected at budget admission. |
| `dispatch.skills.inline.resolved` | `request_id`, `seat`, `model`, `injected`, `dropped`, `total_bytes`, `budget_bytes`, `cache_hit`, `cold_fetches`, `elapsed_ms`, `deadline_hit` | `request_id`, `seat`, `model`, `injected`, `dropped`, `total_bytes`, `budget_bytes`, `cache_hit`, `cold_fetches`, `elapsed_ms`, `deadline_hit` |
| `dispatch.skills.mounted` | `request_id`, `role`, `model`, `canonical_slugs`, `entry_count`, `total_bundle_bytes` | Skills resolved and mounted at endpoint admission. Query via `observability signal-events(signal="dispatch.skills.mounted")` by `request_id`. Join forward to `execution_id` via `endpoint_request_id` on pipeline lifecycle events. Pipeline-trace cannot list these rows (`execution_id=null` at emit time). |
| `dispatch.skills.predicated.rejected` | `request_id`, `role`, `model`, `skills`, `origin` | Caller-supplied MCP-predicated skills rejected on a non-MCP dispatch. |
...
<!-- GENERATED:START region=expand inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `expand.author.completed` | `pipeline_id`, `execution_id`, `step_name`, `target` | Emitted when target author branch completes. |
| `expand.completed` | `pipeline_id`, `execution_id`, `delivery`, `target`, `rag_status`, `provenance_mode` | Emitted when format_output finishes the expand run. |
| `expand.consume.routed` | `execution_id`, `dispatch_id`, `door`, `branch`, `reason`, `fire_hint`, `operator_verb`, `attended`, `durable_session`, `summoning_thread_id` | Emitted when post-expand consume routing selects a delivery branch. |
...
<!-- GENERATED:START region=handoff inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=health inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `health.check.failed` | `model_id`, `error_message`, `socket_path` | Create HEALTH_CHECK_FAILED event. |
<!-- GENERATED:END region=health -->

<!-- GENERATED:START region=inference inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `inference.completed` | `model_id`, `last_inference_time` | Create INFERENCE_COMPLETED event. |
| `inference.context.overflow.retried` | `endpoint`, `original_max_tokens` | Create inference.context.overflow.retried event. |
| `inference.failed` | `model_id`, `request_id`, `error_message` | Create INFERENCE_FAILED event. |
| `inference.resource.update` | _dynamic_ | Create INFERENCE_RESOURCE_UPDATE event. |
| `inference.started` | `model_id` | Create INFERENCE_STARTED event. |
<!-- GENERATED:END region=inference -->

<!-- GENERATED:START region=manage inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `manage.propagation.settle.failed` | `service`, `validation_id`, `restart_intent`, `reason` | Settle hook swallowed an exception after restart. |
| `manage.recycle.completed` | `intent_id`, `service`, `escalated`, `duration_s` | Recycle reached a process restart; ``escalated`` names the force stage. |
| `manage.recycle.drain_attempted` | `intent_id`, `service`, `idle_s` | Drain-gated restart is armed; force is not yet in play. |
| `manage.recycle.escalated` | `intent_id`, `service`, `idle_s`, `active_count`, `stuck_ops?`, `park_attempted?`, `park_refusals?` | Idle-on-no-progress gate tripped; escalate to the existing force kill. |
| `manage.recycle.requested` | `service`, `intent_id?` | Life or code seat asked manage to recycle git_integration_worker. |
| `manage.restart.activation.progress` | `intent_id`, `validation_id`, `progress_class`, `detail?` | Observation-class change during activation verify (idle-clock reset). |
| `manage.restart.activation.unverified` | `intent_id`, `validation_id`, `outcome`, `failure_reason`, `affordances?` | Activation verify window closed without a validated outcome. |
| `manage.restart.activation.validated` | `intent_id`, `validation_id`, `code_ref_relation`, `identity_measurement` | Validation CAS reached ``validated`` with identity evidence. |
...
<!-- GENERATED:START region=measurement inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=monitoring inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `monitoring.error.occurred` | `id`, `timestamp`, `type`, `error_message`, `original_request`, `processing_time_ms`, `stargate_actions`, `token_metrics?`, `gateway_error_details?` | Create MONITORING_ERROR event. |
| `monitoring.parameters.compared` | `id`, `timestamp`, `type`, `model_id`, `user_parameters`, `model_defaults`, `final_parameters`, `parameter_changes`, `processing_time_ms`, `gateway_endpoint`, `summary` | Create MONITORING_PARAMETER_COMPARISON event. |
| `monitoring.preprocessing.completed` | `id`, `timestamp`, `type`, `event_subtype`, `request_id`, `original_request`, `modified_request`, `stargate_actions`, `processing_time_ms`, `gateway_endpoint`, `response`, `token_metrics?`, `model_metadata?` | Create MONITORING_PRE_PROCESSING event. |
| `monitoring.request.info` | `id`, `timestamp`, `type`, `request_id`, `original_request`, `modified_request`, `selected_model`, `response`, `profile_name?` | Create MONITORING_REQUEST_INFO event. |
...
<!-- GENERATED:START region=queue inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `queue.master.entered` | `request_id`, `model_id`, `queue_position`, `compute_type`, `endpoint_category` | Create QUEUE_MASTER_ENTERED event. |
| `queue.master.timed.out` | `request_id`, `model_id`, `timeout_seconds`, `compute_type`, `endpoint_category` | Create QUEUE_MASTER_TIMEOUT event. |
| `queue.master.toctou` | `request_id`, `model_id`, `compute_type`, `endpoint_category`, `retry_count` | Create QUEUE_MASTER_TOCTOU event. |
...
<!-- GENERATED:START region=resource inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=socket inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `socket.orphaned` | `model_id`, `socket_path`, `cleanup_successful`, `error` | Create SOCKET_ORPHANED event. |
<!-- GENERATED:END region=socket -->

<!-- GENERATED:START region=stargate inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `stargate.continuity.checkpoint.admitted` | `execution_id`, `thread`, `surface`, `from_agent` | - |
| `stargate.continuity.checkpoint.card_patched` | `execution_id`, `thread`, `surface`, `from_agent`, `card_uri`, `executor` | - |
| `stargate.continuity.checkpoint.failed` | `execution_id`, `thread`, `surface`, `from_agent`, `stage`, `code` | - |
| `stargate.continuity.checkpoint.posted` | `execution_id`, `thread`, `surface`, `from_agent`, `bus_turn` | - |
| `stargate.continuity.checkpoint.pre_consolidate_degraded` | `execution_id`, `thread`, `surface`, `from_agent`, `reason` | - |
| `stargate.continuity.checkpoint.sealed` | `execution_id`, `thread`, `surface`, `from_agent`, `transcript_id`, `turns_at_cp`, `session_id?`, `coverage?` | - |
| `stargate.continuity.checkpoint.tail_folded` | `execution_id`, `thread`, `family`, `slug`, `journal_applied` | - |
...
<!-- GENERATED:START region=stream inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=system inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
| `system.resources.updated` | `total_vram_mb`, `available_vram_mb`, `total_ram_mb`, `available_ram_mb`, `model_vram?` | Create SYSTEM_RESOURCES_UPDATED event. |
| `system.shutdown` | - | Create SYSTEM_SHUTDOWN event. |
| `system.started` | `pid`, `role`, `started_at`, `version` | Create SYSTEM_STARTED event. |
<!-- GENERATED:END region=system -->

<!-- GENERATED:START region=web_chat inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `web_chat.relay.auth_missing` | `grok_url`, `page_url` | Attended :9222 tab is not signed into the target grok.com chat. |
| `web_chat.relay.started` | `grok_url`, `claude_chat_url` | Relay attached both ends and entered the poll loop. |
| `web_chat.relay.stopped` | `reason`, `relays` | Relay loop exited (SIGINT, max-relays, stop file, or error). |
| `web_chat.relay.tick_retry` | `detail` | One poll tick hit a transient stall (still-generating turn, HTTP |
| `web_chat.relay.turn_filtered` | `direction` | A harvested turn was already attributed to the other side (started |
...
<!-- GENERATED:START region=worker inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `worker.cleanup.requested` | `model_id`, `socket_path`, `supervisor_id`, `reason` | Create worker cleanup request event. |
| `worker.crash.detected` | `model_id`, `error_message`, `socket_path`, `process_pid`, `exit_code` | Create WORKER_CRASH_DETECTED event. |
| `worker.crash.detected` | `model_id`, `error_message`, `socket_path`, `process_pid` | Create worker crash event for vLLM server-managed models. |
| `worker.evicted` | `model_id`, `trigger_model_id`, `vram_freed_mb`, `gateway_name` | Create worker.evicted event. |
| `worker.loading` | `model_id`, `estimated_vram_mb`, `trigger` | Create WORKER_LOADING event. |
| `worker.resource.state.update.requested` | `model_id`, `state`, `error` | Create resource state update request event. |
| `worker.socket.cleanup.requested` | `model_id`, `socket_path` | Create socket cleanup request event. |
...
<!-- GENERATED:START region=density_triage inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=implement_ready inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=resume inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
...
<!-- GENERATED:START region=transcript inventory_sha=2ed6dbaf1278 generated=2026-09-26T06:12:16Z -->
| Signal | Required Payload | Optional Payload |
|--------|------------------|------------------|
| `transcript.source.probed` | `session_id`, `source_present`, `sha_match`, `turn_count` | - |
| `transcript.source.relocate.refused` | `session_id`, `transcript_id`, `expected_sha256`, `actual_sha256` | - |
