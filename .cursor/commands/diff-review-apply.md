...
2. Update `docs/event-contracts.md` for event vocabulary changes. This file is
   manually maintained; it is not a generated or managed artifact.
...
- Always audit docs/contracts after applied changes; `docs/event-contracts.md`
  is manual, not generated
