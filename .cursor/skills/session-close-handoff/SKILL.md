...
trigger_match_terms: ["discipline", "explicit-load", "handoff_prompt", "handoff_upsert", "self-check.", "session-boot-close", "session-close-handoff", "session_close_handoff", "session_handoff_upsert", "voice", "write", "writing"]
...
- Depth gate: `handoff_prompt ∨ handoff_source_path ⇒ transcript_depth ∈ {light, verbatim}`. Never `none` (server 422 `handoff.requires_transcript_entity`). Web/API: `light` + `session_summary_md`; a verbatim turn layer is not required.
