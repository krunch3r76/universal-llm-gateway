...
|---|---|---|---|---|
| `closed` | b≈1–2, shallow T | ≤2 material sub-parts, or answer-space with loci pre-selected | **hypothesize-simulate fill required** (closed detent); shallow L1 optional; ¬ L0 re-open | cheapest |
...
| → R-after | Stage-B closeout present; spec + attrs current; lead fires `/work-item-review todo:{slug}` on **`cdp/opus-5` `purpose=review` `reasoning_effort="high"`** |
