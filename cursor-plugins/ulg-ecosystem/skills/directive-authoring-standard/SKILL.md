...
description: "Before authoring TYPE: DIRECTIVE on the operator-proxy request lane — required fields, wire-contract enum, mint-then-quote, conductor commission, mission negotiation."
skill_category: dispatch-delegation
trigger_short: "TYPE: DIRECTIVE ∨ cursor_request ∨ conductor commission ∨ negotiation_phase"
trigger_match_terms: ["TYPE: DIRECTIVE", "DIRECTIVE", "cursor_request", "mint then quote", "conductor commission", "negotiation_phase", "wire contract", "assumed_state"]
...
| `implement` / `investigate` | `vision:` required |
